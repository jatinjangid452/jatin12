    ...
    import "./lateAttendance.css"


    class LateAttendanceUI extends React.Component {
        constructor() {
            super()
            this.state = {
                disabled: true,
                ...
                res.forEach(doc => {
                    res.forEach(doc => {
                        this.setState({
                            ...
                            change: true,
                            name1: 'show',
                            message: 'Start Your Late Attendance ⌛⌛⌛ ',
                            number: ''
                        })
                ...
                if (res.data() === undefined) {
                    ...
                    if (flag === true) {
                        ...
                        firebaseApp.firestore().collection(`${this.state.class}-${this.state.section}`).doc(`${number}`)
                            .set({ attendance: { [today]: { attendance: "late", time: currentTime, day: saveDay, month: saveMonth } } }, { merge: true })
                        this.setState({
                            name: student.data.studentName,
                            fname: student.data.fatherName,
                            rollNum: student.data.rollNumber,
    ...
    class lateAttendance extends React.Component {
        ...
        render() {
            return (
                <div>
                    <DenseAppBar name="Late Attendance" component={<LateAttendanceUI />} />
                </div>
            )
        }
    }
